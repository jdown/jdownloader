...
public class Browser {
    ...
    /**
     * Allows to change extended ASCII character to real character 
     * 
     * @param      strToNormalize   The string to normalize
     * @return     Normalized string.
     */
    public String normalizeExtendedASCII(String strToNormalize) {
    	strToNormalize = strToNormalize.replace("&#128;", "€");
        strToNormalize = strToNormalize.replace("&#129;", "");
        strToNormalize = strToNormalize.replace("&#130;", ",");
        strToNormalize = strToNormalize.replace("&#131;", "ƒ");
        strToNormalize = strToNormalize.replace("&#132;", "„");
        strToNormalize = strToNormalize.replace("&#133;", "…");
        strToNormalize = strToNormalize.replace("&#134;", "†");
        strToNormalize = strToNormalize.replace("&#135;", "‡");
        strToNormalize = strToNormalize.replace("&#136;", "ˆ");
        strToNormalize = strToNormalize.replace("&#137;", "‰");
        strToNormalize = strToNormalize.replace("&#138;", "Š");
        strToNormalize = strToNormalize.replace("&#139;", "‹");
        strToNormalize = strToNormalize.replace("&#140;", "Œ");
        strToNormalize = strToNormalize.replace("&#141;", "");
        strToNormalize = strToNormalize.replace("&#142;", "Ž");
        strToNormalize = strToNormalize.replace("&#143;", "");
        strToNormalize = strToNormalize.replace("&#144;", "");
        strToNormalize = strToNormalize.replace("&#145;", "‘");
        strToNormalize = strToNormalize.replace("&#146;", "’");
        ...
        strToNormalize = strToNormalize.replace("&#157;", "");
        strToNormalize = strToNormalize.replace("&#158;", "ž");
        strToNormalize = strToNormalize.replace("&#159;", "Ÿ");
        strToNormalize = strToNormalize.replace("&#160;", "");
        strToNormalize = strToNormalize.replace("&#161;", "¡");
        strToNormalize = strToNormalize.replace("&#162;", "¢");
        strToNormalize = strToNormalize.replace("&#163;", "£");
        ...
        strToNormalize = strToNormalize.replace("&#168;", "¨");
        strToNormalize = strToNormalize.replace("&#169;", "©");
        strToNormalize = strToNormalize.replace("&#170;", "ª");
        strToNormalize = strToNormalize.replace("&#171;", "«");
        strToNormalize = strToNormalize.replace("&#172;", "¬");
        strToNormalize = strToNormalize.replace("&#173;", "­");
        strToNormalize = strToNormalize.replace("&#174;", "®");
        ...
        strToNormalize = strToNormalize.replace("&#179;", "³");
        strToNormalize = strToNormalize.replace("&#180;", "´");
        strToNormalize = strToNormalize.replace("&#181;", "µ");
        strToNormalize = strToNormalize.replace("&#182;", "¶");
        strToNormalize = strToNormalize.replace("&#183;", "·");
        strToNormalize = strToNormalize.replace("&#184;", "¸");
        strToNormalize = strToNormalize.replace("&#185;", "¹");
        strToNormalize = strToNormalize.replace("&#186;", "º");
        strToNormalize = strToNormalize.replace("&#187;", "»");
        strToNormalize = strToNormalize.replace("&#188;", "¼");
        strToNormalize = strToNormalize.replace("&#189;", "½");
        strToNormalize = strToNormalize.replace("&#190;", "¾");
        strToNormalize = strToNormalize.replace("&#191;", "¿");
        strToNormalize = strToNormalize.replace("&#192;", "À");
        strToNormalize = strToNormalize.replace("&#193;", "Á");
        strToNormalize = strToNormalize.replace("&#194;", "Â");
        strToNormalize = strToNormalize.replace("&#195;", "Ã");
        strToNormalize = strToNormalize.replace("&#196;", "Ä");
        strToNormalize = strToNormalize.replace("&#197;", "Å");
        strToNormalize = strToNormalize.replace("&#198;", "Æ");
        strToNormalize = strToNormalize.replace("&#199;", "Ç");
        strToNormalize = strToNormalize.replace("&#200;", "È");
        strToNormalize = strToNormalize.replace("&#201;", "É");
        strToNormalize = strToNormalize.replace("&#202;", "Ê");
        strToNormalize = strToNormalize.replace("&#203;", "Ë");
        strToNormalize = strToNormalize.replace("&#204;", "Ì");
        strToNormalize = strToNormalize.replace("&#205;", "Í");
        strToNormalize = strToNormalize.replace("&#206;", "Î");
        strToNormalize = strToNormalize.replace("&#207;", "Ï");
        strToNormalize = strToNormalize.replace("&#208;", "Ð");
        strToNormalize = strToNormalize.replace("&#209;", "Ñ");
        strToNormalize = strToNormalize.replace("&#210;", "Ò");
        strToNormalize = strToNormalize.replace("&#211;", "Ó");
        strToNormalize = strToNormalize.replace("&#212;", "Ô");
        strToNormalize = strToNormalize.replace("&#213;", "Õ");
        strToNormalize = strToNormalize.replace("&#214;", "Ö");
        strToNormalize = strToNormalize.replace("&#215;", "×");
        strToNormalize = strToNormalize.replace("&#216;", "Ø");
        strToNormalize = strToNormalize.replace("&#217;", "Ù");
        strToNormalize = strToNormalize.replace("&#218;", "Ú");
        strToNormalize = strToNormalize.replace("&#219;", "Û");
        strToNormalize = strToNormalize.replace("&#220;", "Ü");
        strToNormalize = strToNormalize.replace("&#221;", "Ý");
        strToNormalize = strToNormalize.replace("&#222;", "Þ");
        strToNormalize = strToNormalize.replace("&#223;", "ß");
        strToNormalize = strToNormalize.replace("&#224;", "à");
        strToNormalize = strToNormalize.replace("&#225;", "á");
        strToNormalize = strToNormalize.replace("&#226;", "â");
        strToNormalize = strToNormalize.replace("&#227;", "ã");
