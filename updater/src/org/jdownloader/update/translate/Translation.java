...
public interface Translation extends TranslateInterface {
    ...
    @Default(lngs = { "en", "de" }, values = { "Updates are ready for Installation.\r\nDetails:\r\n  * Install %s1 new file(s)\r\n  * Remove %s3 outdated file(s)\r\nDo you want to run the update now?", "Updates können jetzt installiert werden.\r\nDetails:\r\n  * %s1 neue Datei(en) installieren\r\n  * %s2 veraltete Datei(en) entfernen\r\nSoll das Update jetzt gestartet werden?" })
